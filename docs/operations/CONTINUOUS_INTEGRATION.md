...
- la referencia inmutable a EAC Pipeline Catalog `v0.4.4`.
...
Pipelines as Code resuelve la Pipeline remota fijada a `v0.4.4`, enlaza
...
de CI-002 referencia EAC Pipeline Catalog `v0.4.4`; su cierre requiere
